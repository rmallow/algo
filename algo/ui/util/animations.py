...
def fadeStart(obj, fromWidget, toWidget, layout, finishedSlot=None):
    ...
    setattr(obj, "_utilAnimation",
            QtCore.QPropertyAnimation(fromWidget.graphicsEffect(), QtCore.QByteArray("opacity")))
    ...
    obj._utilAnimation.finished.connect(lambda: fadeEnd(obj, fromWidget, toWidget, layout, finishedSlot=finishedSlot))
...
def fadeEnd(obj, fromWidget, toWidget, layout, finishedSlot=None):
    ...
    setattr(obj, "_utilAnimation",
            QtCore.QPropertyAnimation(toWidget.graphicsEffect(), QtCore.QByteArray("opacity")))
    obj._utilAnimation.setDuration(500)
